        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title text-center">Data Kategori Dokumen</h4>
                    ...
                    <table id="documentTable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tr data-id="{{ $category->id }}">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            ...
                                            <!-- Tombol Hapus -->
                                            <form action="/documents-categories/{{ $category->id }}" method="POST"
...
<script>
    ...
    $(document).ready(function() {
        ...
        table.on('row-reorder', function(e, diff, edit) {
            ...
            $.ajax({
                url: "{{ route('documents-categories.reorder') }}",
                method: "POST",
                data: {
                    order: order,
                    _token: "{{ csrf_token() }}"
        ...
        $(document).on('click', '.btn-edit-category', function() {
            ...
            if (!$('#documentCategoryForm input[name="_method"]').length) {
                $form.append('<input type="hidden" name="_method" value="PUT">');
            }

            $form.attr('action', '/documents-categories/' + id);

            $.ajax({
                url: '/documents-categories/' + id + '/edit',
                type: 'GET',
